  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const vehicleData = {
        ...
        engineCapacity,
        category
        // registrationStatus, insuranceStatus, inspectionStatus, documentsCount
        // will be set by backend
      };

      const newVehicle = await apiService.addVehicle(vehicleData);

      // Update local storage with the newly created vehicle from backend
      try {
