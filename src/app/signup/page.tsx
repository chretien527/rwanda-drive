...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // For driver role, we use phone/email based on what's available
      // For officer role, we might need different handling (badge ID would need backend support)
      const email = `${fullName.toLowerCase().replace(/\s+/g, '.')}@example.com`; // Placeholder
